...
router.post('/', passport.authenticate('local-signup'), (req, res) => {
    ...
    mailOptions={
        to : req.body.email,
        subject : "¡Bienvenido!",
        html : "<h1><b>¡Bienvenido a RON!</b></h1><br><h2>¡Muchas gracias por registrarse!<br>¡Se le será notificado por este medio cuando la app esté disponible en Google Play Store!</h2>" 
    }
